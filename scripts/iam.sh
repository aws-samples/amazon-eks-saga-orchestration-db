...
i_setup() {
  ...
  POLICY_ARN=`aws iam create-policy --policy-name eks-saga-rds-orche-policy --policy-document file://eks-saga-rds-iam-policy.json.policy --query 'Policy.Arn' --output text`
